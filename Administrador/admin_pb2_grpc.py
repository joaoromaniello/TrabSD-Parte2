...
class AdminStub(object):
    ...
    def __init__(self, channel):
        ...
        self.adicionaClienteTeste = channel.unary_unary(
                '/Admin/adicionaClienteTeste',
                request_serializer=admin__pb2.adicionaClienteTesteRequest.SerializeToString,
                response_deserializer=admin__pb2.adicionaClienteTesteReply.FromString,
                )
...
def add_AdminServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'adicionaClienteTeste': grpc.unary_unary_rpc_method_handler(
                    servicer.adicionaClienteTeste,
                    request_deserializer=admin__pb2.adicionaClienteTesteRequest.FromString,
                    response_serializer=admin__pb2.adicionaClienteTesteReply.SerializeToString,
            ),
    }
...
class Admin(object):
    ...
    @staticmethod
    def adicionaClienteTeste(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Admin/adicionaClienteTeste',
            admin__pb2.adicionaClienteTesteRequest.SerializeToString,
            admin__pb2.adicionaClienteTesteReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
